...
<script src="js/jquery-main.js"></script> 
 ...
 <!-- Bootstrap 3.3.6 -->
  ...
  <div class="back-full-popup" style="background-color:<?=$main_color_sorf?>; position:fixed; z-index:999999; width:100%; padding-right:0px;  box-shadow: 0px 0px 10px #666666; display:nones   ">  
  ...
  <tbody>
    <tr >
     ...
     <div id="number_register_step_1" class="stepnumber <? if($_GET[file]=='profile'){ echo 'stepnumber-active'; } ?>"><center>1</div> 
      ...
      <td style="color:#FFFFFF"   class="font_18" ><b>ข้อมูลส่วนตัวคนขับรถ</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tbody>
     ...
     <div id="number_register_step_3" class="stepnumber"><center>3</div> 
      ...
      <td class="font_18" style="color:#FFFFFF"><b>ข้อมูลรถรับส่งสาธารณะ</td>
