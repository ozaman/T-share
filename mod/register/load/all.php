  ...
  <tbody>
    <tr style="display:none">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            <td width="90" valign="top"><img src="../data/pic/driver/small/<?=$arr[project][username];?>.jpg?v=<?=$arr[project][update_date];?>"  width="100%"   border="0"     style="margin-top:10px;border-radius:5px; padding:5px;" class="div-all-work" /></td>
            <td><table width="100%" border="0" cellspacing="5" cellpadding="1"  style="margin-top:10px;">
              <tr>
                <td width="100"  class="font-20"><font color="#333333"><b>ชื่อจริง</td>
                <td class="font-22"> 
                  <?=$arr[project][name];?>
                  &nbsp;&nbsp;</td>
              </tr>
              <tr>
                <td  class="font-20"><font color="#333333"><b>ชื่อเล่น</td>
                <td class="font-22"> 
                  <?=$arr[project][nickname];?>
                  &nbsp;&nbsp;</td>
              </tr>
              <tbody>
                <tr>
                  <td  class="font-20"><font color="#333333"><b>โทร </td>
                  <td class="font-22"><a href="tel:<?=$arr[project][phone]?>" style="font-size:20px"><b>
                    <?=$arr[project][phone];?>
                  </a></td>
                </tr>
                <tr>
                  <td    class="font-20"><font color="#333333"><b>ประจำ</td>
