...
$vc_chat_load->load( '../data/xml/taxi/payment/driver_".$user_id.".xml' ); 
...
$vc_driver=$load->getElementsByTagName('driver')->item(0)->nodeValue;
...
<?
 ...
 var url_chat = "go.php?name=booking/update&file=new_payment&id=<?=$vc_id?>&driver=<?=$vc_driver?>";
