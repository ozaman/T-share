...
///$('#showmap<?=$_GET[type] ?>').modal('hide');
 //$('#showmap<?=$_GET[type] ?>').modal('hide');
    	...
    	var url_<?=$_GET[type] ?>= "popup.php?name=load/card&file=button&userid=<?=$arr[web_user][post_date];?>&type=<?=$_GET[type] ?>";
$('#pic_<?=$_GET[type] ?>').load(url_<?=$_GET[type] ?>);
    	var url_popup_<?=$_GET[type] ?> = "popup.php?name=load/card&file=pic&userid=<?=$arr[web_user][post_date];?>&type=<?=$_GET[type] ?>";
