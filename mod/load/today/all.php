...
<table width="100%"   style="padding:10px; margin-bottom:10px ; background-color:#FFFFFF;border: solid 1px #DADADA; font-size:22px;"    >
                                    ...
                                    <tr>
                                       <td height="40" style="font-size:24px;" ><b>&nbsp;&nbsp;<? echo $_GET[day]
									   ?> 
									   </td>
                                    </tr>
...
?>
        ...
        <div class="col-md-6" >
	  <div class="box box-danger" style="padding:10px; height:450px;  border: solid 2px #ECF0F5;" onmouseover="this.style.border='solid 2px #FF6600';" onmouseout="this.style.border='solid 2px #ECF0F5';" id="booking_<?=$arr[project][invoice];?>">
    ...
    <td width="90" style="background-color:#F6F6F6 "><? if($arr[product][cartype] == 2){  ?>
      <table width="100%"  border="0" cellspacing="0" cellpadding="2">
        <tr>
          ...
          <td  style="font-size:14px ; font-weight:bold">จอย </td>
        </tr>
      </table>
      <? }else{ ?>
      <table width="100%"  border="0" cellspacing="0" cellpadding="2">
...
<br><table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><div style=" padding-top:5px;  color:<?=$main_color?>;" ><b>
	<a href="tel:<? echo $arr[phone][phone] ;?>" target="_blank"  style="font-size:18px;"> <? echo $arr[phone][phone] ;?></a></b>
	</div></td>
  </tr>
</table>
...
<br><table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="bottom" style="width:20px;color:<?=$main_color?>; font-size:18px;"><b><i class="fa  fa-phone" ></li></b></td>
    <td><div style=" padding-top:5px;  color:<?=$main_color?>;" ><b>
	<a href="tel:<? echo $arr[phoneto][phone] ;?>" target="_blank"  style="font-size:18px;"> <? echo $arr[phoneto][phone] ;?></a></b>
	</div></td>
  </tr>
</table>
...
var url_place_cn = "go.php?name=load/today&file=all&server=cn&day=<?=date('Y-m-d')?>";
	$('#load_cn').show();
