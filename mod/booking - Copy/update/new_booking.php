  ...
  <td   ><div style="font-size:18px; color:#FFFFFF " id="head_full_popup">งานพาแขกช็อปปิ้งใหม่</div></td>
...
$('#booking_payment_<?=$arr[project][id]?>').hide(); 
  ...
  <tbody>
   ...
   <div style="padding:5px;   border-radius: 6px; border: 1px solid #ddd;   background:<? echo $bgcolor; ?>   " class="tab_alert">
     <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
...
$('#load_data_new_alert').fadeOut();
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0" style="padding-top:0px;">
  <tr>
    ...
    <a  href="?name=booking&file=edit&action=edit&id=<?=$_GET[id];?>"   style="color:#FFFFFF; font-size:22px">
    
    <button id="submit_new_booking" type="button" class="btn btn-block btn-primary" style="width:100% ">ตรวจสอบข้อมูล</button>
