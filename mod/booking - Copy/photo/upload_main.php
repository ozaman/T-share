...
<div id="file_photo_loads">
				 ...
				 <input type="file" class="form-control" value="<?echo t_no_photo_available?>" readonly  style="padding-left:5px; padding-right:5px; width:125px" name="load_chat_camera" id="load_chat_camera"  accept="image/*"  capture="camera">
...
setTimeout(function () {
	...
	var url="go.php?name=booking/photo&file=upload_pic&time=<?=time()?>";
	url=url+"&type="+document.getElementById('upload_pic_type').value;
	url=url+"&vc="+document.getElementById('work_vc').value;
