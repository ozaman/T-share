...
<table width="100%"  border="0" cellspacing="1">
  <tr align="center">
    <td width="100" align="center" bgcolor="#999999"  class="font_16" style="height:30px; "><font color="#FFFFFF"><strong>วันที่</strong></td>
    <td width="60" align="center" bgcolor="#999999"  class="font_16"><font color="#FFFFFF"><strong>ค่าจอด</strong></td>
    <td width="60" align="center" bgcolor="#999999"  class="font_16"><font color="#FFFFFF"><strong>ค่าหัว</strong></td>
    <td align="center" bgcolor="#999999"  class="font_16" style="padding-right:0px; "><font color="#FFFFFF"><strong> 
 รวม
...
<table width="100%"  border="0" cellspacing="0" cellpadding="2">
  <tr align="center">
    <td width="100" style="height:35px; "  class="font_16"><?=$arr[timeline][dayall]?></td>
...
<table width="100%"  border="0" cellspacing="2" cellpadding="2"  >
  <tr  >
    <td  class="font_18" style="height:30px; padding-left:5px; ">ค่าหัว</td>
    <td width="40%" align="right"  class="font_24" style="padding-right:10px; color:#000000 "> 
...
<table width="100%"  border="0" cellpadding="2" cellspacing="2"  style="background-color:#F6F6F6;border:  solid 1px #999999;  ">
  <tr  >
     <td  class="font_18" style="height:30px; padding-left:5px; ">รายได้รวม</td>
