...
<div style="display: nonea"  id="map_aaaa">
 ...
 <div id="showDD"   style="display: none">  
	...
	if(navigator.geolocation){
			navigator.geolocation.getCurrentPosition(function(position){
				...
				var infowindow = new GGM.InfoWindow({
					 map: map,
					position: pos,
					content: '<font color="#333333" style="font-size:22px "><b>คุณ<?=$arr[web_user] [nickname]?>อยู่ที่นี่'
				});
				
				var image = 'images/icon_map/point/complete.png';
