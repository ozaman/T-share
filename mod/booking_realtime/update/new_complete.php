  ...
  <td   ><div style="font-size:18px; color:#FFFFFF " id="head_full_popup">แจ้งถึงสถานที่ส่ง</div></td>
...
<br>
 ...
 <table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tbody>
    <tr>
      <td width="30"><i class="fa fa-map-marker" style="width:20px;font-size:32px;"></i>
      
 
    </td>
      <td id="status_<?=$arr[project][id]?>" class="font-32"> 
   ...
   <b>ถึงสถานที่ส่ง
      ...
      <div style="font-size:14px; color:#009999; padding-bottom:0px; ">
    ...
    <div style="padding-bottom:3px; ">
      ...
      <table width="100%" border="0" cellspacing="5" cellpadding="1">
        <tr>
          <td width="110"  class="font-22"><font color="#333333"></font><b>เลขจอง</td>
        ...
        <tr>
          <td    class="font-22"><font color="#333333"><b>ใช้เวลา</td>
  ...
  ?>
        ...
        <tr>
          <td class="font-22"><font color="#333333" ><b>สัญชาติ&nbsp; </td>
...
?>
  ...
  <td width="80" align="center" bgcolor="#<?=$plate_color?>" style="border: solid 2px; color:#DADADA; padding:5px; padding-right:10px;border-radius:5px;"><font color="#<? if($arr[other][plate_color]=="Green"){
	 ...
	 echo "FFFFFF"; } ?>"  class="font-26"><b><? echo $arr[other][plate_num];?> <br> 
              <font   class="font-20"><? echo $arr[other][province];?></font></b></font></td>
  </tr>
  <?
...
?>
      ...
      <tr>
        <td width="80"  class="font-18"><strong>ประเภท</strong></td>
        <td  class="font-18"><? echo "" . $arr[aum][topic_en] . " "; ?></td>
      </tr>
      <tr>
        <td class="font-18"><strong>ยี่ห้อ</strong></td>
        <td class="font-18"><?echo $arr[other][car_brand];?></td>
      </tr>
      <tr>
        <td class="font-18"><strong>รุ่น</strong></td>
        <td class="font-18"><?echo $arr[other][car_sub_brand];?></td>
      </tr>
    </table></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" style="padding:5px;">
  <tbody>
     ...
     <tr>
       <td width="100" class="font-22">ชื่อ-นามสกุล</td>
       <td class="font-20"><?=$arr[dv][name]?> (<?=$arr[dv][nickname]?>)</td>
     </tr>
     
     
     <tr style="display:none">
       <td width="100" class="font-22">ชื่อเล่น</td>
       <td class="font-20">&nbsp;</td>
     </tr>
     
          <tr>
       <td width="100" class="font-22">โทรศัพท์</td>
       <td class="font-20">
