...
<div  style="padding-top:0px; padding:5px; ">
 ...
 <table width="100%"  border="0" cellspacing="1">
   <tr align="center">
    ...
    <td width="60" align="center" bgcolor="#999999"  class="font-16" style="height:30px; font-size:16px "><font color="#FFFFFF"><? echo t_person_fee?></strong></td>
...
<? } ?>
 ...
 <table width="100%"  border="0" cellspacing="2" cellpadding="2" style="border-top:  solid 1px #999999; margin-top:10px; display:none  ">
  <tr  >
    <td  class="font-16" style="height:30px; padding-left:5px; display:none  "><? echo t_parking_fee?></td>
