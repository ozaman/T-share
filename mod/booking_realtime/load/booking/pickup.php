 ...
 <div  style="padding:5px;   border-radius: 5px; border: 1px solid #ddd;background-color:#FFFFFF;  margin-bottom: 0px; box-shadow: 0px  0px 0px #DADADA  ; margin-top: 10px;">      
     ...
     <div class="topicname">รอส่งแขกกลับ</div>
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <? if($arr[project][wait_status]=='out'){?>     checked="checked" <? } ?>
    ...
    >
      ...
      <td><div   style="color:#1B7E5A;"  class="font-26" ><b>ส่งออก</div></td>
    </tr>
  </tbody>
</table>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none"  id="selet_check_to_place">
  <tbody>
    <tr>
      <td width="50%" style=" padding-right:5px;">                    
        <div class="topicname">เวลากลับ
  ...
  $db->connectdb(DB_NAME_APP,DB_USERNAME,DB_PASSWORD);
      ...
      <td width="50%"><div class="topicname">ส่งกลับที่
          <table width="100%" border="0" cellspacing="0" cellpadding="0" >
          <tbody>
            <tr>
              <td class="font-24"><span style="height:35px;"></span>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none"  id="selet_check_to_airport">
  <tbody>
    <tr>
      <td width="50%" style=" padding-right:5px;">                    
        <div class="topicname">เวลากลับ
  ...
  $db->connectdb(DB_NAME_APP,DB_USERNAME,DB_PASSWORD);
      ...
      <td width="50%"><div class="topicname" style="margin-top: 0px; padding-bottom:5px;">ส่งออกที่ </div>
          <table width="100%" border="0" cellspacing="0" cellpadding="0" >
          <tbody>
            <tr>
  ...
  <tbody>
    <tr>
      <td><i class="fa   fa-plane " style="font-size:28px; margin-top:5px;"></i></td>
      <td><span style="margin-top:-5px;" class="font-24">สนามบินภูเก็ต</span></td>
    </tr>
  </tbody>
</table>
