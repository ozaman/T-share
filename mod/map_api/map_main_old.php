  ...
  <body >
    ...
    <script>
      ...
      function setMarker(){
	   ...
	   /* var current_div = document.getElementById("current_location");
 		var current = new RichMarker({
		    map: map,
		    position: map.getCenter(),
		    draggable: false,
		    flat: false,
            ...
            success: function(res) {
				...
				$.each(obj.data, function (key, val) {
			        ...
			        var position = new google.maps.LatLng(val.main.lat, val.main.lng);
		 			 ...
		 			 $('#load_mod_popup_map').append('<div class="marker-place" id="icon_marker_'+val.main.id+'" ><i class="fa '+val.icon.logo_code+'" style="z-index: 1000;font-size:30px;left: 7px;top: 6px;position:  absolute;"></i></div>');
...
<div id="infowindow_event" class="map-search-modal" style="background-color:#f6f6f600;display:none;
