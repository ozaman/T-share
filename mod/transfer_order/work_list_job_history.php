...
<div style="margin-top: 50px;margin-bottom:0px;">
	<div style="padding:0px 0px; margin: auto;">
	  ...
	  <input type="hidden" class="form-control" value="<?=$_POST[date];?>"  name="date_transfer_work" id="date_transfer_work" style="background-color:#FFFFFF; height:40px; font-size:24px;z-index: 0;padding:10px;margin-bottom: 10px;border-radius: 8px;"  > 
...
function QueryData(){
	...
	$.post( "mod/transfer_order/action_work_job_history.php?action=query_work&driver=<?=$_COOKIE["app_remember_user"];?>",{ date:date },function( data ) {
			var obj = JSON.parse(data);
			console.log(obj);
			if(obj==null){
			  ...
			  console.log('****************')
                 ...
                 $.post( "mod/transfer_order/component_work_list_job_history.php?dis="+distance+"&du="+duration, value, function( component ) {
			  	console.log('========================')
			  	// console.log(value)
			  	console.log('asadsas')
			  	console.log('========================')
