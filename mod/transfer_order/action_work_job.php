	...
	mysql_query("SET character_set_results=utf-8");
			...
			$res = $db->select_query("SELECT a.*, c.topic_en AS topic_en,
		       ...
		       b.area
				...
				where a.id>0 ".$filter_date." and a.driver = '".$_GET[driver]."'  and a.type = 'Transfer' and CAST(a.arrival_time as time) > '".date('H:m:s')."' ".$filter_fashion." order by CAST(a.arrival_time as time) asc");
