...
setInterval(function() {
    $('#show_timer').text((today.getSeconds() - start));
}, 1000);
*/
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><div   style="border:none; color:#FFFFFF; font-size:16px; position:absolute; margin-left:50px;    z-index:1000000 "><center><i class="fa fa-microphone"  style=" font-size:120px ; margin-top:5PX;  "   ></i>
	
	<div id="show_timer" style=" font-size:40px; margin-top:5px; "></div>
	
	</center></font></b>  </div><div style="margin-top:-0px; text-align:center   "><br>
<br>
 <br>
<br>
<br>
<canvas id="level"   height="100" width="170"  ></canvas>
