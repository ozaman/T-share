<div id="popup_chat_share_map_realtime"    style="width:100%; height:100%; padding:0px;  left:0px;  top:0px;   z-index:99999; background-color:#FFFFFF; position:absolute;  display:none; margin-top:0px;">
   ...
   <div class="back-full-popup" style=" height:60px;width:100%   " >
  ...
  <td   ><div style="font-size:18px; color:#FFFFFF " id="head_full_popup"><center>Katathani Phuket Beach Resort<? //=chat_send_location_realtime?><br />
<font color="#FFFFCC">( Kata | Phuket)</center></div></td>
