...
<a  id="button_alert_show_wait_now"><div  class="drop-sub-menu-link" style="color:#000000; font-size:16px; ">&nbsp; <?=chat_send_location?></span></font></b></div></a>
<a id="button_alert_show_wait_realtime"><div  class="drop-sub-menu-link" style="border:none; color:#000000; font-size:16px; ">&nbsp;  <?=chat_send_location_realtime?></font></b>  </div></a>
