 <div class="back-full-popup" style="width:100%; margin-left:-10px; "> 
  ...
  <div style="font-size:18px; color:#FFFFFF " > T-Booking Chat (2)</b></div></td>
...
$('#sub_menu_chat_add_contact').click(function(){  
 ...
 var url_chat_main = "load_page_show.php?name=livechat/all/load&file=add_contact&driverid=<?=$user_id?>&chat_from=driver&lang=th";
...
$('#sub_menu_chat_add_group').click(function(){  
 ...
 var url_chat_main = "load_page_show.php?name=livechat/all/load&file=add_group&driverid=<?=$user_id?>&chat_from=driver&lang=th";
...
<script>
 ...
 var url_chat = "<?=$chat_part?>go.php?name=livechat/all/load&file=list_contact&chat_from=<?=$chat_from?>&lang=<?=$_GET[lang]?>";
