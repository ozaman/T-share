			  ...
			  <? if($arr[chat][comment_from]==$chat_from){?>
                <div class="direct-chat-msg right" >
                  <div class="direct-chat-info clearfix" style="margin-top:10px; margin-bottom:10px; ">
                    ...
                    <span class="direct-chat-timestamp pull-left"> <?=$date = date('Y-m-d ',  $arr[chat][post_date]);?>&nbsp;<font color="#000000"><?=$date = date('h:i:s',  $arr[chat][post_date]);?></font></span>
                  </div>
 
  <!-- /.direct-chat-info -->
<img class="direct-chat-img" src="../../admin/file/driver/pic/small/<?=$arr[web_user][post_date];?>.jpg" alt="Message User Image"><!-- /.direct-chat-img -->
