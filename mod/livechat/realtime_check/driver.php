...
<table width="100%"  border="0" cellspacing="0" cellpadding="0"  style="background-color:#f6f6f6 "  >
  <tr>
	...
	<img src="../../../../../admin/file/driver/pic/<?=$arr[web_user][post_date];?>.jpg"  width="100%"   border="0"  class="IMGSHOP"   style="margin-top:5px;border-radius:5px;" />
 ...
 .tdtable  td {height:20px;}
	 ...
	 $plate_color="FF0000"; } ?><table width="100%" cellpadding="0" cellspacing="0"  style="margin-left:0px;  margin-right: 0px; margin-bottom:0px; margin-right:0px; " >
       <?
