...
$res[project] = $db->select_query("SELECT id,topic_en,topic_cn,topic_th,company,code,type,province,status FROM ".TB_product."   ");
...
@unlink("../data_file/xml/product/id/".$arr[project][id].".xml");
@$fd = @fopen("../data_file/xml/product/id/".$arr[project][id].".xml", "a+");
@fputs($fd, $product . "\n\n");
@fclose($fd);
