...
<?
   ...
   $all_price_commision_all=$price_commision_all;
   		  ?>
<table width="350" border="0" cellspacing="0" cellpadding="0"  class="box-bottom-lines" style="padding-top:5px;">
   <tr>
      <td width="30">
         <? if($park==1){?>
         <div class="font-22">
                  ...
                  <td bgcolor="#FFF" class="main_td_park" align="center">
                     ...
                     <table width="50" border="0" align="center" cellpadding="2" cellspacing="2"  >
                        <tbody>
                           <tr>
                              <td width="70" align="center" valign="top" bgcolor="#C7EAFB" style="display:none">
                                 <? if($park==1){?><strong><?=t_company;?></strong>   <? } ?>        
                              ...
                              <td width="70" align="center" valign="top" bgcolor="#C7EAFB" class="check_load_park_all">
                                 <? if($park==1){?><strong><?=t_member;?></strong><? } ?>                       
