...
<style>
.number_price{ padding-top:5px; font-size:20px;  width:80px; text-align:right; padding-right:15px;
...
?>
 ...
 $res[extra_park] = $db->select_query("SELECT * FROM plan_product_price_extra WHERE  from_number <= $number AND to_number >= $number  and plan_setting=".$_GET[plan_setting]." and type='park' and plan_type='".$_GET[type]."' and control='user' and pay_type='driver'");
...
$res[extra_person] = $db->select_query("SELECT * FROM plan_product_price_extra WHERE  from_number <= $number AND to_number >= $number  and plan_id=".$_GET[plan_setting]." and type='person' and plan_type='".$_GET[type]."' and control='user' ");
 $arr[extra_person] = $db->fetch($res[extra_person]);
 
  
$res[extra_com] = $db->select_query("SELECT * FROM plan_product_price_extra WHERE  from_number <= $number AND to_number >= $number  and plan_id=".$_GET[plan_setting]." and type='commision' and plan_type='".$_GET[type]."' and control='user' ");
    ...
    <tr>
     ...
     <? //=$_GET[plan_setting]?>
      <table width="50" border="0" align="center" cellpadding="2" cellspacing="2" >
        <tbody>
          <tr>
            <td width="70" align="center" valign="top" bgcolor="#C7EAFB" style="display:none"><? if($park==1){?>
              <strong>บริษัท</strong>
              <? } ?>
              <div class="number_price" >
                <?= number_format($price_park_company, 0 );?>
              </div></td>
            <td width="70" align="center" valign="top" bgcolor="#F6F6F6" class="check_load_park_driver"> <div class="number_price" style="width:40px;"><B><?= number_format($park, 0 );?></div>
 </td>
            <td width="70" align="center" valign="top" bgcolor="#C7EAFB" class="check_load_park_counter"><? if($park==1){?>
              <strong> เคาน์เตอร์ </strong>
              <? } ?>
              <div class="number_price">
                <?= number_format($price_park_counter, 0 );?>
              </div></td>
            <td width="70" align="center" valign="top" bgcolor="#C7EAFB" class="check_load_park_all"><? if($park==1){?>
      ...
      <td class="font-22"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
     ...
     <? if($park==1){?>
            ...
            <div class="font-30">
             ...
             <? } ?> 
              ...
              <tbody>
                <tr>
                  <td width="70" align="center" valign="top" bgcolor="#C7EAFB" style="display:none"><? if($park==1){?><strong>บริษัท</strong>   <? } ?>        
                  ...
                  <td width="70" align="center" valign="top" bgcolor="#C7EAFB" class="check_load_park_driver"><? if(0==1){?><strong> คนขับ </strong>  <? } ?>
       <div class="number_price"><?= number_format($price_park_driver, 0 );?></div>
                  ...
                  <td width="70" align="center" valign="top" bgcolor="#C7EAFB" class="check_load_park_counter"><? if($park==1){?><strong> เคาน์เตอร์ </strong><? } ?>
       <div class="number_price"><?= number_format($price_park_counter, 0 );?></div>
                    
                    </td>
                  <td width="70" align="center" valign="top" bgcolor="#C7EAFB" class="check_load_park_all"><? if($park==1){?><strong>สมาชิก</strong><? } ?>                       <div class="number_price"><?= number_format($price_park_all, 0 );?></div>
     ...
     <? if($park==1){?>
            ...
            <table width="50" border="0" align="center" cellpadding="2" cellspacing="2" >
              <tbody>
                <tr>
                  <td width="70" align="center" valign="top" bgcolor="#FFFDE9"  style="display:none"><? if($park==1){?>
                    <strong>บริษัท</strong>
            ...
            <? if($park==1){?>
              ...
              <tbody>
                <tr>
                  <td width="70" align="center" valign="top" bgcolor="#E9FBCF"  style="display:none"><? if($park==1){?>
                    <strong>บริษัท</strong>
                  ...
                  <div class="number_price"><?= number_format($all_price_commision_driver, 0 );?>%</div>
			...
			<? if($park==1){?><div class="font-30">
              ...
              <table width="50" border="0" align="center" cellpadding="2" cellspacing="2" >
                <tbody>
                  <tr>
                    <td width="70" align="center" valign="top" bgcolor="#F6F6F6"  style="display:none"><? if($park==1){?>
                      <strong>บริษัท</strong>
                      <? } ?>
                      <div class="number_price">
                    ...
                    <td width="70" align="center" valign="top" bgcolor="#Fff" class="check_load_commision_driver"><span class="check_load_park_driver">
                      <? if(0==1){?>
                      <strong> คนขับ </strong>
                      <? } ?>
                      </span>
                    ...
                    <td width="70" align="center" valign="top" bgcolor="#F6F6F6" class="check_load_commision_counter"><strong><span class="check_load_park_counter">
                      <? if($park==1){?>
                      <strong> เคาน์เตอร์ </strong>
                      <? } ?>
                      </span></strong>
                    ...
                    <td width="70" align="center" valign="top" bgcolor="#F6F6F6" class="check_load_commision_all"><span class="check_load_park_all">
                      <? if($park==1){?>
                      <strong>สมาชิก</strong>
                      <? } ?>
                      </span>
