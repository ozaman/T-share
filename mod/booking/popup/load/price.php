...
<div class="topicname">ค่าจอด ค่าหัว<br>
...
<?
  ...
  $res[shop] = $db->select_query("SELECT * FROM  product_price_list where product_id=".$_GET[shop_id]."  and  plan_id=".$_GET[plan_id]." and master=$master  ORDER BY id  ");
...
?>
 ...
 <?  if ($arr[nation][status]==1 and $master==0){ ?>
 
 <table width="100%" border="0" cellspacing="1" cellpadding="1"  class="box-bottom-line" style="padding-top:5px;">
 
    <tr>
      <td> 
            <div class="font-20"><img src="images/flag/<?=$arr[nation][name_en]?>.png" width="30" height="30" alt="" style="margin-top:-5px;"/> &nbsp;<?=$arr[nation][name_th]?> </div>
