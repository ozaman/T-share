...
<div  style="padding-top:0px; padding:5px; ">
 ...
 <table width="100%"  border="0" cellspacing="1">
   <tr align="center">
    <td width="100" align="center" bgcolor="#999999"  class="font-16" style="height:30px; font-size:16px "><font color="#FFFFFF"><?=t_date;?></strong></td>
    <td width="60" align="center" bgcolor="#999999"  class="font-16" style="height:30px; font-size:16px ; display:none "><font color="#FFFFFF"><?=t_parking_fee;?></strong></td>
    <td width="60" align="center" bgcolor="#999999"  class="font-16" style="height:30px; font-size:16px "><font color="#FFFFFF"><?=t_person_fee;?></strong></td>
...
<? } ?>
 ...
 <table width="100%"  border="0" cellspacing="2" cellpadding="2" style="border-top:  solid 1px #999999; margin-top:10px; display:none  ">
  <tr  >
    <td  class="font-16" style="height:30px; padding-left:5px; display:none  "><?=t_parking_fee;?></td>
...
<table width="100%"  border="0" cellspacing="2" cellpadding="2"  >
  <tr  >
    <td  class="font-16" style="height:30px; padding-left:5px; "><?=t_person_fee;?></td>
    <td width="40%" align="right"  class="font_24" style="padding-right:10px; color:#000000 "> 
...
<table width="100%"  border="0" cellpadding="2" cellspacing="2"  style="background-color:#F6F6F6;border:  solid 1px #999999;  ">
  <tr  >
     <td  class="font-16" style="height:30px; padding-left:5px; "><?=t_total_revenue;?></td>
