...
<div  style="padding-top:0px; padding:5px; ">
 ...
 <table width="100%"  border="0" cellspacing="1">
   <tr align="center">
    <td width="100" align="center" bgcolor="#999999"  class="font-16" style="height:30px; font-size:16px "><font color="#FFFFFF"><strong>วันที่</strong></td>
    <td width="60" align="center" bgcolor="#999999"  class="font_16" style="height:30px; font-size:16px "><font color="#FFFFFF"><strong>ค่าจอด</strong></td>
    <td width="60" align="center" bgcolor="#999999"  class="font_16" style="height:30px; font-size:16px "><font color="#FFFFFF"><strong>ค่าหัว</strong></td>
    <td align="center" bgcolor="#999999"  class="font_16" style="padding-right:0px; font-size:16px  "><font color="#FFFFFF"><strong> 
  รวม
...
<table width="100%"  border="0" cellspacing="0" cellpadding="2">
  <tr align="center">
    ...
    <td width="60" align="right"  class="font_16"><?= number_format($park, 0 );?></td>
    <td width="60" align="right"  class="font_16"><?= number_format($pay-$park, 0 );?></td>
    <td align="right"  class="font_16" style="padding-right:10px; "> <B>
	<? if($pay>0){?>
	<?= number_format( $pay , 0 );?>
		<? } ?>
...
<? } ?>
 ...
 <table width="100%"  border="0" cellspacing="2" cellpadding="2" style="border-top:  solid 1px #999999; margin-top:10px; ">
  <tr  >
    <td  class="font-18" style="height:30px; padding-left:5px; ">ค่าจอดรถ</td>
...
<table width="100%"  border="0" cellspacing="2" cellpadding="2"  >
  <tr  >
    <td  class="font-18" style="height:30px; padding-left:5px; ">ค่าหัว</td>
    <td width="40%" align="right"  class="font_24" style="padding-right:10px; color:#000000 "> 
...
<table width="100%"  border="0" cellpadding="2" cellspacing="2"  style="background-color:#F6F6F6;border:  solid 1px #999999;  ">
  <tr  >
     <td  class="font-18" style="height:30px; padding-left:5px; ">รายได้รวม</td>
