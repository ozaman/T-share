...
.ui-datepicker {
    ...
    padding: 0; left:0px; z-index:99999; position:fixed;  
  }
  .ui-widget {
    font-size: 16px;  
  }
...
<form method="post"  id="edit_form" name="edit_form">
  ...
  <div class="<?= $coldata?>" style="display:nones" >
              ...
              <div id="block_pickup_place">
                ...
                <ul class="nav nav-tabs" style="padding-top:0px; height:40px; margin-left:-0px; border:none">
 
 
       <li    id="btn_chk_booking_place"  class="active" ><a data-toggle="tab" href="#tab_chk_name"><i class="fa  fa-bank"  fa-spin 6x style="color:#666666;font-size:18px;"></i><strong>เลือกสถานที่</strong></a ></li>
  ...
  <input name="pickup_place" type="text"  required="true" class="form-control" id="pickup_place" style="padding:4px 2px;width:97%;" onkeypress="PasswordEnter(this,event)" value="Patong Beach Hotel " >
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tbody>
    <tr>
      <td width="60%"> 
        ...
        <div class="input-group date" style="z-index:0; position:relative;">
        
        
 
        
          <input type="text" class="form-control" value="<?=date('Y-m-d');?>"  name="transfer_date_new" id="transfer_date_new"    style="background-color:#FFFFFF; height:40px; font-size:16px;  " readonly>
      ...
      <td width="40%">
         ...
         <div class="topicname">เวลารับ</div>
        ...
        <tbody>
          <tr>
            <td><table width="100%" border="0" cellspacing="1" cellpadding="1">
              <tbody>
                <tr>
                  <td>  <select class="form-control"  name="transfer_pickup" id="transfer_pickup" >
  ...
  $db->connectdb(DB_NAME_APP,DB_USERNAME,DB_PASSWORD);
                      ...
                      <? //  include ("mod/booking/load/booking/pickup.php");   ?>
...
<div class="font-24" id="text_to_time" style="color:<?=$main_color?>"></div>
  ...
  <tbody>
   ...
   <div style="padding-top:10px; color:#FF0000" class="font-22">
        ฟรีสำหรับเด็กอายุเต่ากว่า 18 ปี
           </div>       
 ...
 <div class="<?= $coldata?>" style="display:noneS">
                     ...
                     <div class="topicname">ค่าบริการ</div>
  ...
  $res[category] = $db->select_query("SELECT * FROM  plan_product_price_list where status=1 and product_id=".$arr[shop][id]."   ORDER BY id asc");
      ...
      <div style="padding:5px;   border-radius: 0px; border: 0px solid #ddd;background-color:#F6F6F6;     margin-bottom: 5px; box-shadow: 0px  0px 0px #DADADA; display:none  ;">
...
<table width="100%" border="0" cellspacing="1" cellpadding="1"  style=" margin-top:10px;">
    ...
    <tr>
      <td width="35%" align="center" bgcolor="#F6F6F6" style="display:none"> 
      ...
      <td width="45%" align="center" bgcolor="#F6F6F6"> 
  ...
  <tbody>
    <tr>
      <td width="45" >  <div id="div_price_person" class="font-24" style="text-align:center"> <div></td>
      <td width="10" > * </td>
      <td width="45" ><div id="div_all_person" class="font-24" style="text-align:center"> <div></td>
    </tr>
  </tbody>
</table>
    ...
    <td width="35%" align="center" bgcolor="#F6F6F6" style="display:nones"> 
      
       <input  name="price_park" type="hidden" class="form-control" id="price_park"  > 
            <div class="topicname" style="text-align:center">คอมมิชชั่น</div>
            
            
            <div id="div_price_com" class="font-24"  style="text-align:center"> <div>
 ...
 <?
  ...
  include ("mod/booking/load/booking/bank.php");
 ...
 ?>
  ...
  if($_GET[type]=='edit'){ 
   ...
   include ("mod/booking/load/edit/status.php");
...
/// url_load_price=url_load_price+"&lng="+document.getElementById('check_data_status_gps_lng_old').value;
 ...
 ///
  ...
  $("#adult").change(function(){ 
    ...
    var url_load_price= "popup.php?name=booking&file=price_transfer";
...
$("#btn_calendar").click(function(){
 ...
 $('#transfer_date_new').datepicker('show'); 
