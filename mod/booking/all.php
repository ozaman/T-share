...
<div  style="margin-top:40px;" id="main_component">
   ...
   <div style="padding: 8px 0px;">
      <table width="100%">
         <tr>
            <td width="50%">
               <div id="btn_manage" class="btn_filter_active tocheck" align="center" onclick="filterMenu('manage');" ><span class="font-22"><?=t_process;?></span></div>
            </td>
            <td width="50%">
               <div id="btn_his" class="btn_filter tocheck" align="center" onclick="filterMenu('his');" ><span class="font-22"><?=t_history;?></span></div>
            </td>
         </tr>
      </table>
   </div>
