...
$db->connectdb(DB_NAME_APP,DB_USERNAME,DB_PASSWORD);
  ...
  <div style="padding: 8px 0">
  		<table width="100%">
		    ...
		    color: #3b5998;
		    padding: 5px 30px;
		    border: 2px solid #3b5998;" onclick="transfer_status()"><span><? echo t_customer?></span></div></td>
		  	</tr>
		 </table>
  </div>
  ...
  <ul class="nav nav-tabs" style="width:100%; margin-top:10px;">
    ...
    <li style="width:50%; text-align:center" id="btn_load_clock_day_2"><a><span class="font-26"><? echo t_yesterday?></span><span data-toggle="tooltip" class="badge "   style="position:absolute; margin-left:5px; border-radius: 20px; height:25px; width:25px; background-color:#999999; text-align:center; padding-top:5px; " id="number_bottom_chat" ><span  class="font-20"><?=$numday_2?></span></span></a></li>
