    ...
    <tr>
      ...
      <table width="100%" border="0" cellpadding="2" cellspacing="5">
        <tbody>
          ...
          <tr>
            <td width="90"  class="font-26 "><b>เวลาถึง&nbsp;<?=$_GET[airout_h].".".$_GET[airout_m]." น.";?></b> </td>
            <!--<? if($arr[to][time_h]>0){ ?>
              <?=$arr[to][time_h]?>
              ชั่วโมง
              <? } ?>
        ...
        <tr >
          ...
          <div class="border-alert">
           <!-- <button id="submit_booking_step_4" type="button" class="btn  btn-primary" style="width:100%; background-color:#F7941D "><span class="font-28"><i class="    fa fa-save "></i>&nbsp;บันทึกข้อมูล</button>-->
            <button id="submit_booking_step_4" type="button" class="btn btn-primary" style="width:100%; background-color:#F7941D "><span class="font-28">ยืนยัน</span>
            </button></div>
            </td>
        </tr>
      </table></td>
