...
$db->connectdb(DB_NAME_APP,DB_USERNAME,DB_PASSWORD);
$res[car] = $db->select_query("SELECT * FROM   web_carall  where drivername='".$user_id."' order by id desc  ");
...
$( "#load_mod_popup_4" ).toggle();
  ...
  var url_load_new_car_booking = "load_page_mod_4.php?name=car&file=new_car";
