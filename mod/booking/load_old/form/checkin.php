...
<table width="100%" border="0" cellpadding="1" cellspacing="5" id="table_show_hide_checkin_<?=$arr[project][invoice];?>">
  ...
  <tr id="booking_topoint_<?=$arr[project][id]?>" style="display:nones">
    <td width="100" class="font-22"><div class="tab_alert"><button id="complete_booking_data_<?=$arr[project][id]?>" type="button" class="btn  btn-info"  style="width:100%;text-align:left;padding:5px "><span class="font-22"><i class="fa  fa-map-marker" style="width:20px;"  ></i> แจ้งถึงแล้ว</button></class></td>
