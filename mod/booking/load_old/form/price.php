...
><table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tbody>
    <tr>
      <td height="30" class="font-28 "><font color="<?=$text_topic_color?>" ><b> รายได้  <font color="#FF0000">(ยังไม่จ่ายเงิน)</font></td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="font-22"><?=$arr[project][price_person_unit]; ?>
        x
        <?=$arr[project][register_pax]; ?>
        =
        <?=$arr[project][price_person_unit]*$arr[project][register_pax] ?></td>
    </tr>
    <tr>
