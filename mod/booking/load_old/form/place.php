  ...
  <style>
   .div-all-palce{
	 padding:5px;   border-radius: 8px; border: 1px solid #ddd;background-color:#F6F6F6;     margin-bottom: 5px; box-shadow: 0px  0px 0px #DADADA  ;
 ...
 <table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tbody>
    <tr>
      ...
      <td class="font-2"><span class="font-28" style="color:<?=$main_color?>"><b><? echo $arr[shop][topic_th];?></span>
...
<span class="font-28" style="color:#333333"><b><? echo $arr[shop][topic_en];?></span>
      ...
      <style>
      	...
      	<div id="shop_sub_menu_map_<?=$arr[project][id]?>" class="map-box" align="center">
      		<span><i class="fa  fa-map-marker fa-2x" style="font-size:24px;color:<?=$main_color?>" ></i><br/><strong>นำทาง</strong></span>
      	</div>
