...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tbody>
    ...
    <tr>
      ...
      <td width="33%" align="left" id="time_complete_booking_data2_<?=$arr[project][id]?>" class="font-22">
  ...
  <tbody>
    <tr>
      ...
      <td width="33%" align="left" id="time_complete_booking_dataxxx_<?=$arr[project][id]?>"  > 
 ...
 */
  ...
  <tbody>
    <tr>
      ...
      <td width="33%" align="left"    ><div class="btn  btn-default" style=" width:100%; text-align:left;  padding:2px;height:40px;" data-toggle="dropdown" id="shop_sub_menu_map_<?=$arr[project][id]?>">
        <table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tbody>
            <tr>
