...
<div id="file_photo_loads">
				 ...
				 <input type="file" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:125px" name="load_chat_camera" id="load_chat_camera"   accept="image/*">
...
setTimeout(function () {
	...
	var url="go.php?name=booking/load/form/checkin/photo&file=upload_pic&action=upload";
...
//										 document.getElementById('check_photo_'+pictype).value=1;
    ...
    success: function()
    {
       ...
       $('#icon_camera_checkin').addClass('btn-success');
