...
//	$("#step_guest_receive_<? echo $arr[project][id];?>").show();
	...
	$("#box_driver_pay_report_<?=$arr[project][id];?>").removeClass('border-alert');
...
<table width="300" border="0" align="center" cellpadding="5" cellspacing="5">
  <tbody>
    <tr>
      <td align="center" class="font-30"><i class="icon-new-uniF121-10" style=" font-size:80px; color:<?=$main_color?>"  ></i></td>
    </tr>
    <tr>
