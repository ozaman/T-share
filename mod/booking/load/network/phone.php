...
<?
   ...
   ?>
<script>
   $(".text-topic-action-mod-4" ).html("<?=t_drop_place;?> (<?=$arr[shop][$place_shopping]?>)");
</script> 
<?
   $db->connectdb(DB_NAME_APP,DB_USERNAME,DB_PASSWORD);
            ...
            <td>
               <table width="100%" border="0" cellpadding="2" cellspacing="0">
                  <tbody>
                     <tr>
                        <td>
<a  href="tel://<?=$arr[contact][phone]?>"  id="booking_edit"   style=" font-size:18px; margin-left:0px; padding:0px;   text-transform:uppercase; color:<?=$main_color?>; text-decoration:none">
<b>   <?=$arr[contact][name]?>  <div style="margin-left:50px; position:absolute; margin-top:-20px; color:#3333333"><?=$arr[contact][phone]?> </div></b>
</a>
</td>
</tr>
<tr>
