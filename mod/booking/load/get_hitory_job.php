	...
	$date_result = date("H:i:s", $time);		
			$res = $db->select_query("SELECT a.*, c.topic_en AS topic_en,
		       ...
		       b.area
				...
				where a.id>0 ".$filter_date." and a.driver = '".$_GET[driver]."' and guest_topoint = 1  and a.type = 'Transfer'  order by CAST(a.arrival_time as time) asc");
