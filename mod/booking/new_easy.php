    ...
    <tr>
      <td width="60%"> 
        ...
        <div class="input-group date" style="z-index:0">
          ...
          <input type="text" class="form-control" value="<?=date('Y-m-d');?>"  name="transfer_date_new" id="transfer_date_new"    style="background-color:#FFFFFF; height:40px; font-size:16px " readonly="true">
...
<div class="font-24" id="text_to_time" style="color:<?=$main_color?>"></div>
                          ...
                          <div class="<?= $coldata?>" id="show_car_detail">
...
<div class="<?= $coldata?>" id="show_to_timesss" style="display:nones">
              <div>
                <div class="topicname">เบอร์โทรศัพท์คนขับรถ</div>
                
                <? if($data_user_class=='taxi' and $_GET[type]<>'edit' ){ ?>
     
                <input name="phonedriver" type="number"    id="phonedriver"   class="form-control"    value="" >  
                
                
             <? }  else {?>   
             
             
              <input name="namedriver" type="number"    id="namedriver"   class="form-control"    value="<?=$arr[project][namedriver]?>" >  
...
<div class="<?= $coldata?>" id="show_to_timesss" style="display:nones;margin-top:10px;"  > 

<div  style="margin-top:10px; color:#FF0000" id="chk_register">
...
ยังไม่ได้ลงทะเบียนในระบบ
 ...
 <? ///   include ("mod/booking/load/booking/guest.php");   ?>
 ...
 ?>
  ...
  if($_GET[type]=='edit'){ 
   ...
   ?>
    ...
    <input  name="booking_type"  type="hidden" class="form-control"  id="booking_type" value="<?=$_SESSION['data_user_type']?>"   > 
    
    <input  name="booking_by"  type="hidden" class="form-control"  id="booking_by" value="<?=$_SESSION['data_user_id']?>"   > 
    
        <input  name="booking_ref"  type="hidden" class="form-control"  id="booking_ref" value="<?=$_SESSION['data_user_id']?>"   > 
...
alert('กรุณาเลือกการแจ้งรอรับแขก'); 
