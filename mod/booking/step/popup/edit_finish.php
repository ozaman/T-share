...
<div class="<?= $coldata?> edit-zone" id="edit_time" style="display:none">
			...
			<div align="center" style="margin-top:15px;"><button type="button" style="width: 70%;" class="btn btn-success main-color" id="apply_edit_time"><span class="font-28">ยืนยัน</span></button></div>
	</div>
...
<div class="<?= $coldata?> edit-zone" id="edit_guest" style="margin-top:10px; display:none ">
		...
		<div align="center" style="margin-top:15px;"><button type="button" style="width: 70%" class="btn btn-success main-color" id="apply_edit_guest"><span class="font-28">ยืนยัน</span></button></div>
	</div>	
  ...
  <tbody>
    <tr>
      ...
      &nbsp;
		...
		<div align="center" style="margin-top:15px;"><button type="button" style="width: 70%" class="btn btn-success main-color" id="apply_edit_payment"><span class="font-28">ยืนยัน</span></button></div>
	</div>
...
<div class="<?= $coldata?> edit-zone" id="edit_transfer_detail" style="margin-top:55px;padding:5px;   border-radius: 10px; box-shadow: 0px  0px 5px #DADADA  ; display:none ">
		...
		<div align="center" style="margin-top:15px;"><button type="button" style="width: 70%" class="btn btn-success main-color" id="apply_edit_car"><span class="font-28">ยืนยัน</span></button></div>
	</div>	
