      ...
      <td colspan="2" valign="middle" class="box-bottom-line"><table width="100%" border="0" cellpadding="2" cellspacing="2"  >
        <tbody>
          <tr>
            ...
            <div  class="payment-menu" id="pay_person_taxi_<?=$arr[project][id];?>" style="<?=$color_menu;?>" >
              <center>
              <i class="icon-new-uniF11E-5" style="font-size:24px; margin-left:-5px;    "  ></i>
              </center>
              </div>
              </td>
            <td ><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody>
                <tr>
                  <td class="font-24"><font color="#333333" class="text_cap" ><b><?=t_person_fee;?></b></font></td>
                </tr>
                <tr>
  ...
  <td width="120" align="right" class="font-20" id="price_person_time_payment_<?=$arr[project][id];?>">
    ...
    <tr  class="box-bottom-line">
      ...
      <td align="right" class="font-20" id="price_park_time_payment_<?=$arr[project][id];?>"><span class="font-24">
        <b><?= number_format($arr[project][price_person_unit], 0 );?></b>
      </span></td>
    </tr>
    <tr>
...
//			$('#upload_doc_pay_park_<?=$arr[project][id]?>').click();
		 	...
		 	var url_load= "load_page_mod_3.php?name=booking/load/form&file=upload_pay_popup&id=<?=$arr[project][id]?>&type=<?=$type;?>&invoice=<?=$arr[project][invoice]?>&check_confirm=<?=$check_person;?>&price=<?= number_format($arr[project][price_park_total], 0 );?>";
