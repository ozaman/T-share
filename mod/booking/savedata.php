...
//		exit();
	...
	*/
	...
	$db->closedb();
	// /// à¸ªà¸£à¹‰à¸²à¸‡à¸£à¸²à¸¢à¸à¸²à¸£ à¸„à¹ˆà¸²à¸„à¸­à¸¡
	...
	// include ("mod/booking/sendmail/new.php");
	// //// passport
	$_GET[code] = $_POST[upload_pic_time];
	copy("../data/fileupload/store/passport/" . $_GET[code] . "_small.jpg", "../data/fileupload/passport/" . $last_id . "_small.jpg");
	copy("../data/fileupload/store/passport/" . $_GET[code] . "_big.jpg", "../data/fileupload/passport/" . $last_id . "_big.jpg");
	unlink("../data/fileupload/store/passport/" . $_GET[code] . "_small.jpg");
	unlink("../data/fileupload/store/passport/" . $_GET[code] . "_big.jpg");
	// /
	// ////////////// à¹€à¸•à¸·à¸­à¸™ à¹‚à¸­à¸žà¸µ
	$_GET[vc] = $last_id;
	// //// à¸ªà¸£à¹‰à¸²à¸‡à¹„à¸Ÿà¸¥à¹Œ
	$folder_xml = "../data/xml";
	$newvc = "" . "<?xml version=\"1.0\" encoding=\"utf-8\" ?>\n" . "<newvc>\n";
...
// $('#load_mod_popup').html(load_main_mod);
	// /alert('à¸šà¸±à¸™à¸—à¸¶à¸à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¸Šà¹‡à¸­à¸›à¸›à¸´à¹‰à¸‡à¹à¸¥à¹‰à¸§');
// /$( "#load_mod_popup_4" ).toggle();	
// window.location.href = "?name=booking&file=today"; //will redirect to your blog page (an ex: blog.html)
	</script>
<?php
	} 
if ($_GET[action] == 'edit')
	...
	// /// à¸«à¸² plan à¸„à¹ˆà¸²à¸ˆà¸­à¸”à¹€à¸à¸´à¸™
	...
	*/
	...
	$db->update_db('order_booking', array(
		...
		*/
		...
		"passport_pic" => "$_POST[check_photo_passport]",
		"guest_name" => "$_POST[guest_name]",
		// / à¹„à¸¡à¹ˆà¸¡à¸µà¸à¸²à¸£à¸­à¸±à¸žà¹€à¸”à¸—
		// /"drivername" => "$_GET[driver]",
		"ondate_time" => "$_POST[ondate_time]",
