...
<div class="stepbar">
 <div class="progress" style="border-radius:0px;height : 8px !important;background-color:#cccccc;">
   <div class="progress-bar" id="step_1" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width:20%;background-color:rgb(106, 194, 89);display: none;/*box-shadow: #f4f4f4 1px 1px 5px;*/">
