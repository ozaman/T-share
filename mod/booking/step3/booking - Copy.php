...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tbody>
    <tr>
      ...
      <div id="small_step_1" class="border-alert" style=" padding-top:10px;" >
    ...
    <tr>
      ...
      <div id="small_step_2" class="border-alert_none" style=" padding-top:10px;" >
    ...
    <tr>
      <td>
        ...
        <div id="small_step_3" class="border-alert_no" style=" padding-top:10px;" >
...
<p>
 ...
 ///
  $("#small_step_1").removeClass("border-alert");
  
  $("#small_step_2").addClass("border-alert");
...
return false ;
 ...
 $("#show_guest_detail").fadeIn(1000);
  ...
  $("#small_step_1").removeClass("border-alert");
   $("#small_step_2").removeClass("border-alert");
   
  
  $("#small_step_3").addClass("border-alert");
 ...
 $("#show_guest_detail").hide();
   ...
   $("#small_step_2").removeClass("border-alert");
      ...
      $("#small_step_3").removeClass("border-alert");
   
  
  $("#small_step_1").addClass("border-alert");
