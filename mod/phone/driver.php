  ...
  function startDictation() {
    ...
    if (window.hasOwnProperty('webkitSpeechRecognition')) {
      ...
      recognition.onresult = function(e) {
        ...
        recognition.stop();
			      var url_phone = "go.php?name=load/phone&file=driver";
				  url_phone=url_phone+"&sound="+document.getElementById('sound').value;
...
-->
 ...
 <!--ss-->
   ...
   <div class="box box-default">
          <h2 class="box-title"><span class="font_24"><b>เบอร์โทรศัพท์คนขับรถ</b></span></h2>
  ...
  <button id="submit_load_phone" type="button" class="btn btn-block btn-primary" style="width:160px; "><i class="fa fa-phone"></i> เบอร์โทรศัพท์ทั้งหมด</button>
	    ...
	    <div class="btn-group">
  <button type="reset" class="btn btn-block btn-default"  style="width:80px; position: static" data-toggle="modal" data-target="#form_add_phoneหห" onclick="startDictation()" ><i class="fa fa-microphone"></i> ค้นหา</button> </div>
  
	 
</div>
  </div>
<input type="text" name="q" id="sound" placeholder="เสียงพูด"  style="width:242px;" />
<!--แสดงผล-->
<div id="load_phone_data" > <?  include "mod/load/phone/driver.php" ;?></div>
