...
$arr[chkcar] = $db->fetch($res[chkcar]);
 ...
 ?>
         ...
         <table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td id="load_time_start_car"> <input name="check_mile" type="number"  class="form-control" id="check_mile"  style="font-size:30px; height:50px;" onKeyPress="if(this.value.length==6) return false;"/></td>
  </tr>
</table>
...
<script>
 ...
 <table width="100%"  border="0" cellspacing="2" cellpadding="2"  >
  <tr>
    ...
    <td width="50%" style="padding:5px;"><button type="reset" class="btn btn-block btn-default"  style="width:100% " id="reset_use_car">รีเซ็ต</button>
