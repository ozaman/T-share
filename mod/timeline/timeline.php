...
<? if($i==1){?>
  ...
  <tr>
    <td style="font-size:30px; color:#FFFFFF; font-weight:bold "><center><?=$i;?>ss</center></td>
  </tr>
</table>
</div> </td>
    <td width="90" style="background-color:#F6F6F6 " >dd
	...
	<? if($arr[product][cartype] == 2){  ?>
      <table width="100%"  border="0" cellspacing="0" cellpadding="2">
        <tr>
		  ...
		  <img src="images/users.png"  align="absmiddle"  /></td>
          <td  style="font-size:14px ; font-weight:bold">ร่วม </td>
        </tr>
      </table>
      <? }else{ ?>
