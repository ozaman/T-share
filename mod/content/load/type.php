...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tbody>
    ...
    <td width="60" align="center" bgcolor="#999999"><font color="#FFFFFF">สถานที่ทั้งหมด</font></td>
    <td width="60" align="center" bgcolor="#999999"><font color="#FFFFFF">เปิด</font></td>
    </tr>  
  <?
...
///
 ...
 $('#topic_edit').html('แก้ไข <? echo $arr[sub][topic_en];?>:<? echo $arr[project][topic_th];?>');
  ...
  $('#show_data_page').load(url_page_type_<? echo $arr[sub][id];?>);
   ...
   <td align="center"><? echo $openPlace = $db->num_rows('shopping_product',"id","sub=".$arr[sub][id]." and status = 1");?></td>
 </tr>
	  <TR>
