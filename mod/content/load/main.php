...
<!--    <td width="60" align="center" bgcolor="#999999"><font color="#FFFFFF">ลำดับ</font></td>-->
    <td width="60" align="center" bgcolor="#999999"><font color="#FFFFFF">สถานที่เปิด</font></td>
    </tr>  
  <?
  
	$db->connectdb(DB_NAME_APP,DB_USERNAME,DB_PASSWORD);
 
$res[project] = $db->select_query("SELECT * FROM shopping_product_main  ORDER BY  topic_en  ASC  ");
...
///
 ...
 <?
  ...
  <td align="center" id="naum_all_place_<? echo $arr[project][id];?>">  
        ...
        <td align="center"><? echo $openPlace = $db->num_rows('shopping_product',"id","main=".$arr[project][id]." and status = 1");?></td>   
 </tr>
	  <TR>
