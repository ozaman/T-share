...
<table width="100%"  border="0" align="center" cellpadding="2" cellspacing="2" style="max-width:350px; ">
 ...
 <b> <img src="images/logo.png?v=6"    style="padding-bottom:0px;margin-top:10px;"      />   
 ...
 <button   class="btn btn-block div-all-btn " style="background-color:#5a78b5; color:#FFFFFF;margin-top:10px;"   id="btn_login_login"><i class="fa fa-sign-in" style=" font-size:24px;"  ></i><span style=" font-size:24px;">&nbsp;เข้าสู่ระบบ</span></button>
