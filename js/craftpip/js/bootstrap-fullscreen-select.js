    ...
    Mobileselect.prototype = {
        ...
        _appendOptionsList: function () {
            ...
            $.each(this.options, function (i, a) {
                ...
                if(a.value=='Green'){
					var div_color = '<span style="padding: 10px;padding-right:20px;"><button style="box-shadow:1px 1px 2px #00a65a;background-color:#00a65a;width:40px;height:20px;border-radius:15px;" class="btn btn-sm"></button></span>';
				}else if(a.value=='Yellow'){
					var div_color = '<span style="padding: 10px;padding-right:20px;"><button style="box-shadow:1px 1px 2px #e8e813;background-color:#e8e813;width:40px;height:20px;border-radius:15px;" class="btn btn-sm"></button></span>';
				}else if(a.value=='Red'){
					var div_color = '<span style="padding: 10px;padding-right:20px;"><button style="box-shadow:1px 1px 2px Red;background-color:Red;width:40px;height:20px;border-radius:15px;" class="btn btn-sm"></button></span>';
				}else if(a.value=='Black'){
					var div_color = '<span style="padding: 10px;padding-right:20px;"><button style="box-shadow:1px 1px 2px Black;background-color:Black;width:40px;height:20px;border-radius:15px;" class="btn btn-sm"></button></span>';
				}else if(a.value=='Gray'){
					var div_color = '<span style="padding: 10px;padding-right:20px;"><button style="box-shadow:1px 1px 2px Gray;background-color:Gray;width:40px;height:20px;border-radius:15px;" class="btn btn-sm"></button></span>';
				}else if(a.value=='Golden Bronze'){
					var div_color = '<span style="padding: 10px;padding-right:20px;"><button style="box-shadow:1px 1px 2px #715e0f;background-color:#715e0f;width:40px;height:20px;border-radius:15px;" class="btn btn-sm"></button></span>';
				}else if(a.value=='Silver Bronze'){
					var div_color = '<span style="padding: 10px;padding-right:20px;"><button style="box-shadow:1px 1px 2px Silver;background-color:Silver;width:40px;height:20px;border-radius:15px;" class="btn btn-sm"></button></span>';
				}else if(a.value=='White'){
					var div_color = '<span style="padding: 10px;padding-right:20px;"><button style="box-shadow:1px 1px 2px #ddd;background-color:White;width:40px;height:20px;border:1px solid #ddd;border-radius:15px;" class="btn btn-sm"></button></span>';
				}
				else{
					var div_color = '';
				}
                
                that.$listcontainer.append('<a href="#" class="mobileSelect-control" ' + b +' data-value="' + a.value + '"  >'+ div_color + a.text +'</a>');
//                that.$listcontainer.append('<a href="#" class="mobileSelect-control" ' + b +' data-value="' + a.value + '"  ><table width="100%"><tr><td width="50">'+div_color+'</td><td style="font-size:18px;color:#3b5998;">'+a.text+'</td></tr></table></a>');
