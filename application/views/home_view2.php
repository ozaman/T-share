...
<link rel="stylesheet" href="<?=base_url();?>assets/onsenui2.9.2/css/onsenui.css?v=<?=time()?>">
<link rel="stylesheet" href="<?=base_url();?>assets/onsenui2.9.2/css/onsen-css-components.min.css?v=<?=time()?>">
  <script src="<?=base_url();?>assets/onsenui2.9.2/js/onsenui.js?v=<?=time()?>"></script>
...
<template id="home.html">
  <ons-page>
    ...
    <ons-button onclick="performClick('upload');">xxxx</ons-button>
    <!--<ons-input type="file" id="fileupload"> </ons-input>-->
    ...
    <br/>
    <br/>
     <a onclick="thisFileUpload();">aaaaaaaaaaaaaaaaaa</a>
     <br/>
    <br/>
    <br/>
    <button onclick="thisFileUpload();">ccccccccccccccccccc</button>
...
//                  alert(elemId);
          ...
          var a = 0;
           function thisFileUpload() {
            ...
            setTimeout(function(){ document.getElementById("upload").click(); }, 750);
//            if(a==0){
//              thisFileUpload();
//            }
//            a = a+1;
