...
<ons-row>
  ...
  <ons-col style="margin: 10px;">
   <center>
	  	<div onclick="fn.pushPage({'id': 'transfer.html', 'title': 'ให้บริการรถ', 'key':'transfer'})" class="circle-menu" style="    background-color: #F7941D;">
...
<ons-row>
  <ons-col style="margin: 10px;">
	  <center>
	  	<div onclick="fn.pushPage({'id': 'book_trans.html', 'title': 'จองรถ', 'key': 'book_trans'})" class="circle-menu" style="    background-color: #1CC1A4;" >
  ...
  <ons-col style="margin: 10px;">
   <center>
	  	<div onclick="fn.pushPage({'id': 'book_tour.html', 'title': 'จองทัวร์',  'key': 'book_tour' })" class="circle-menu" style="    background-color: #8DC63F;">
	      <div class="content">
