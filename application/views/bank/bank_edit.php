...
<form name="form_editbank" id="form_editbank"  enctype="multipart/form-data">
  ...
  <ons-card  class="card">
    ...
    <div align="center" style="margin-top: 10px;">
      <!--      <div >
              <input type="file" class="cropit-image-input" accept="image/*" id="img_book_bank" onchange="readURLbank(this, 'img_book_bank', 'edit');"  style="opacity: 0;position: absolute;">
            </div>-->
...
border-top-left-radius: 5px; pointer-events: none;"><i class="fa fa-camera" aria-hidden="true"></i>&nbsp; อัพโหลดรูปถ่าย</span>-->
      <div class="upload-btn-wrapper" >
        ...
        <input type="file" id="img_book_bank" accept="image/*" onchange="readURLbank(this, 'img_book_bank', 'edit');"/>
      </div>
    </div>
  </ons-card>  
...
<!--      <span style="background-color: #f4f4f4;
      ...
      <div class="upload-btn-wrapper" >
        <button class="btn-f" type="button"><i class="fa fa-camera" aria-hidden="true"></i> อัพโหลดรูปถ่าย</button>
        <input type="file" id="img_qrcode_bank" accept="image/*" onchange="readURLbank(this, 'img_qrcode_bank', 'edit');"/>
      </div>
    </div>
  </ons-card>  
</form>
