            ...
            <div class="chat-toolbar">
              <div class="clearfix" style="    padding: 0 5px;">
                ...
                <table width="100%">
                  <tr>
                    <td>
                      <input type="test" tabindex="-1" class="form-control" placeholder="พิมพ์ข้อความ" maxlength="5000" id="data" class="ember-text-area ember-view" style="font-size: 16px;
                             width: 100%;
                             height: 38px;
                             padding: 0px 10px;
...
//        console.log(5555);
    $('.tabbar').show();
    $('.tabbar__content').css('bottom', '49px');
  });
