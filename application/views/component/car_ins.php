...
<?php 
	...
	?>
		<ons-list-item id="item_bank_list_<?=$val[id];?>" class="list-item" onclick="selectCarIns('<?=$val[id];?>','<?=$val[name_th];?>');" data-name="<?=$val[name_th];?>">
...
?>
	<ons-list-item id="item_bank_list_0" class="list-item" onclick="selectCarIns('0','อื่นๆ');" data-name="อื่นๆ">
	            ...
	            <div class="center list-item__center">อื่นๆ</div>
	    </ons-list-item>
</ons-list>
