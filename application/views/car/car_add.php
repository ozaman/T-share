...
<form name="form_addcar" id="form_addcar"  enctype="multipart/form-data">
  ...
  <ons-card  class="card">
    ...
    <ons-list-item class="input-items list-item p-l-0" >
      ...
      <div class="center list-item__center custom-sl-pd" id="car_gen_box" 
           onclick="selectCarGen();">
...
border-top-left-radius: 5px; pointer-events: none;"><i class="fa fa-camera" aria-hidden="true"></i>&nbsp; อัพโหลดรูปถ่าย</span>-->
      <div class="upload-btn-wrapper" >
        ...
        <input type="file" id="img_car_1" accept="image/*" onchange="readURLcar(this, 'img_car_1', 1, 'add');"/>
      </div>
    </div>
  </ons-card>   
...
border-top-left-radius: 5px; pointer-events: none;"><i class="fa fa-camera" aria-hidden="true"></i>&nbsp; อัพโหลดรูปถ่าย</span>-->
      <div class="upload-btn-wrapper" >
        <button class="btn-f" type="button"><i class="fa fa-camera" aria-hidden="true"></i> อัพโหลดรูปถ่าย</button>
        <input type="file" id="img_car_2" accept="image/*"  onchange="readURLcar(this, 'img_car_2', 2, 'add');" />
      </div>
    </div>
  </ons-card>  
...
border-top-left-radius: 5px; pointer-events: none;"><i class="fa fa-camera" aria-hidden="true"></i>&nbsp; อัพโหลดรูปถ่าย</span>-->
      <div class="upload-btn-wrapper" >
        <button class="btn-f" type="button"><i class="fa fa-camera" aria-hidden="true"></i> อัพโหลดรูปถ่าย</button>
        <input type="file" id="img_car_3" accept="image/*"  onchange="readURLcar(this, 'img_car_3', 3, 'add');" />
      </div>
    </div>
  </ons-card> 
  ...
  <!--<form name="form_accescar" id="form_accescar"  enctype="multipart/form-data">
              <div >
                <input type="file" class="cropit-image-input" accept="image/*" id="img_car_act"  
  style="opacity: 0;position: absolute;" onchange="readURLother(this,'img_car_act','add','car_act');">
              </div>
              <div >
                <input type="file" class="cropit-image-input" accept="image/*" id="img_car_tax"  
  style="opacity: 0;position: absolute;" onchange="readURLother(this,'img_car_tax','add','car_tax');">
              </div>
              <div >
                <input type="file" class="cropit-image-input" accept="image/*" id="img_car_insurance"  
  style="opacity: 0;position: absolute;" onchange="readURLother(this,'img_car_insurance','add','car_insurance');">
              </div>
  </form>-->
  <ons-card  class="card">
...
border-top-left-radius: 5px; pointer-events: none;"><i class="fa fa-camera" aria-hidden="true"></i>&nbsp; อัพโหลดรูปถ่าย</span>-->
      ...
      <div class="upload-btn-wrapper" style="margin-bottom: 5px;" >
        <button class="btn-f" type="button"><i class="fa fa-camera" aria-hidden="true"></i> อัพโหลดรูปถ่าย</button>
        <input type="file" id="img_car_act" accept="image/*"  onchange="readURLother(this, 'img_car_act', 'add', 'car_act');" />
      </div>
    </div>
...
border-top-left-radius: 5px; pointer-events: none;"><i class="fa fa-camera" aria-hidden="true"></i>&nbsp; อัพโหลดรูปถ่าย</span>
      ...
      <div class="upload-btn-wrapper" style="margin-bottom: 5px;" >
        <button class="btn-f" type="button"><i class="fa fa-camera" aria-hidden="true"></i> อัพโหลดรูปถ่าย</button>
        <input type="file" id="img_car_tax" accept="image/*"  onchange="readURLother(this, 'img_car_tax', 'add', 'car_tax');" />
      </div>
    </div>
...
<!--      <span style="background-color: #f4f4f4;
      ...
      <div class="upload-btn-wrapper" style="margin-bottom: 5px;" >
        <button class="btn-f" type="button"><i class="fa fa-camera" aria-hidden="true"></i> อัพโหลดรูปถ่าย</button>
        <input type="file" id="img_car_insurance" accept="image/*"  onchange="readURLother(this, 'img_car_insurance', 'add', 'car_insurance');" />
      </div>
    </div>
    <div align="center">
