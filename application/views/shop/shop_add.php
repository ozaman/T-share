            ...
            <tr>
              ...
              <td>
                <div class="element_to_find">
                  ...
                  <span class="font-17" style="color:#3b5998">ดิวตี้ฟรี </span ><span class="pull-right" onclick="fun_imageslider('<?=$_GET[shop_id];?>')" style="font-size: 20px;  margin-right: 5px;  color: #0076ff;"><i class="fa  fa-camera take-photo-icon"></i></span><br>
