  ...
  <div class="card shop_company_box_<?=$data->id;?>" id="shop_company_box_<?=$data->id;?>" >
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-bottom : 0px solid #DADADA;" id="row_place_<?=$data->id;?>">
      <tr>
        <td width="130">
          <?php
          $url = "../data/pic/place/".$data->id."_logo.jpg";
       ...
       <td valign="top">
        ...
        <strong class="font-17"  style="color:#3b5998" ><span class="txt_topic_company " data-search="<?=$data->topic_th. " ".$data->topic_cn." ".$data->topic_en;?>  " data-role="<?=$data->id;?>"> <?=$data->topic_th;?> </span></strong>
