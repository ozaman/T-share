...
</table>  <?  //include ("google/gps/check.php");?><br />
...
?>
 ...
 <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDJa08ZMaSnJP5A6EsL9wxqdDderh7zU90&libraries=places<?=$callback?>&language=<?=$lng_map;?>&v=<?=time();?>">
    </script>
