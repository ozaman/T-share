...
function SplitPage($page="",$totalpage="",$option=""){
	...
	?>
<li style="display:nones">
		<script>

function showcontentpage(numpage) {

//alert(numpage);

loadurl= "load_data.php<?=$option?>&page="+numpage;

 

//$("#main_page_load" ).load('load/page/loading.php'); 

 $("#main_page_load" ).load(loadurl); 
...
<li>	
	...
	if($page>1 && $page<=$totalpage) {
		...
		$ShowSumPages .= "<a class='pgnavi'   onClick='showcontentpage(".$prevpage.");' title='ย้อนกลับ'><font size='2' color='#FFFFFF'>".button_back."</a>\n";

	} else {
	
			$ShowSumPages .= "<a class='pgnavi-none'   ><font size='2' color='#FFFFFF'>".button_back."</a>\n";
	...
	if($page!=$totalpage) {
		...
		$ShowSumPages .= "<a class='pgnavi' onClick='showcontentpage(".$nextpage.");'   title='หน้าถัดไป'><font size='2' color='#FFFFFF'>".button_next."</a>\n";
		...
		$ShowSumPages .= "<a class='pgnavi-none' onClick='showcontentpage(".$nextpage.");'   title='หน้าถัดไป'><font size='2' color='#FFFFFF'>".button_next."</a>\n";
...
$ShowPages .= "<a class='mynavi' onClick='showcontentpage(".$i.");'>$i</a> \n";

	}

$ShowPages .= "<a class='mynavi2' >$i</a> \n";

	for($i=($page+1); $i<($c+21) ; $i++) {

		if($i<=$totalpage)

		//$ShowPages .= "<a class='mynavi' id='btn_numpage_next".$i."' href='".$option."&page=$i'>$i</a> \n";
$ShowPages .= "<a class='mynavi' onClick='showcontentpage(".$i.");'>$i</a> \n";
	...
	$ShowPages .= "<a class='pgnavi' onClick='showcontentpage(".$nextpage.");' title='10 หน้าถัดไป'>".$c."20 หน้าถัดไป</a> \n";
