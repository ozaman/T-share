...
function openSheetActionNoti(active, id) {
  if (active == 1) {
    var txtRead = "ทำเครื่องหมายยังไม่ได้อ่าน";
  } else {
    var txtRead = "ทำเครื่องหมายอ่านแล้ว";
  }
  ons.openActionSheet({
    cancelable: true,
    buttons: ['ซ่อน', txtRead, {
        label: 'ลบ',
...
function makeUnReadNotification(id) {
