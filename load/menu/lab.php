...
//      	 	alert();
	  ...
	  <li id="btn_taxi_list"  class="treeview" style="display: nones;" onclick="taxiList();" >
         <a href="#">
         <i class="fa fa-book l-menu-li-icon-main" style="margin-left: 0;"></i> <span class="textmain-left-menu">&nbsp;&nbsp;<? echo รายชื่อแท็กซี่ทั้งหมด;?></span>
         <span class="pull-right-container">
