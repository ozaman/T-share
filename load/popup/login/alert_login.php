...
?> 
   <input name="loginusername"    id="loginusername" maxlength="7" style="font-size:18px ; height:40px;  text-transform:uppercase; background-color:#fff" value="<?=$_GET['user'];?>" placeholder="ชื่อผู้ใช้งาน" autocomplete="off">    
       ...
       <? } else {?>  
                ...
                <input name="loginusername"  class="form-control" id="loginusername"  maxlength="7" style="font-size:18px ; height:40px; border-radius:20px; text-transform:uppercase;background-color:#fff" value="<?=$_COOKIE['app_remember_user'];?>" placeholder="ชื่อผู้ใช้งาน" autocomplete="off">
...
?> 
  ...
  <input name="loginpassword"  id="loginpassword"  type="password" class="form-control"  style="font-size:18px ; height:40px;"   value="<?=$_GET['pass'];?>" placeholder="รหัสผ่าน" autocomplete="off">    
            ...
            <? } else {?> 
            <input name="loginpassword"  id="loginpassword"  type="password" class="form-control"  style="font-size:18px ; height:40px;border-radius:20px"   value="<?=$_COOKIE['app_remember_pass'];?>" placeholder="รหัสผ่าน" autocomplete="off">         
...
.radio-password:hover { width:25px; height:25px; box-shadow:none; margin-top:10xp; background:none;  border-radius:25px}
  ...
  <tr>
      <td style="background-color:#FFFFFF ">  <button type="button" id="submit_login" class="btn btn-block btn-main-color" style="background-color:#3b5998; color:#FFFFFF;font-size: 26px; border-radius:26px">เข้าสู่ระบบ</button></td>
  
  </tr>
  <tr>
      <td style="background-color:#FFFFFF "><button type="button" id="forget_inform_login" class="btn btn-block " style="margin-top:15px;background-color:#666666; color:#FFFFFF;font-size: 26px;border-radius:26px">ลืมข้อมูลเข้าระบบ</button></td>
