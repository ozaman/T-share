...
<div class="outer-password" >
 ...
 <div class="back-full-popup"> 
  ...
  <tr>
    <td width="40"   ><div class="button-close-popup-password" ><?=$popup_icon_left_arow;?></div></td>
  <td   ><div style="font-size:22px; color:#FFFFFF " id="text_mod_topic_action" class="text-topic-action-mod">ลืมข้อมูลเข้าสู่ระบบ</div></td>
    <td width="50" align="right"   ><div style="font-size:22px; color:#FFFFFF " id="head_full_popup_icon"><i class="fa fa-unlock-alt" style=" font-size:26px;"  ></i></div></td>
  </tr>
</table>
</div>      
