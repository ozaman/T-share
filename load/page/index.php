...
<html>
   ...
   <body class="hold-transition skin-blue sidebar-mini"  style="background-color:#F5F5F5;overflow-x: hidden !important" >
      ...
      <aside class="main-sidebar" id="load-main-sidebar" style="/*width: 300px;*/border-right: 1px solid #ddd;position:fixeds;box-shadow:1px 1px 5px #dadada;"   >
         <!-- search form -->
         <!-- /.search form -->
      ...
      <div class="content-wrapper" style="/*margin-top:55px;*/padding-top:55px; "  >
         <div >
            ...
            <div style="padding:0px ; margin-top:-20px; margin-left:0px; margin-right:0px; margin-bottom:10px   ">
               <div id="load_mod_data"  style="padding:0px;padding-bottom:0px; padding-top:15px;">
                  <?  include ("".$MODPATHFILE."");?>  
               </div>
            </div>
            </section>
